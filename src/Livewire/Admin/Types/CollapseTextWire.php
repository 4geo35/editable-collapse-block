...
namespace GIS\EditableCollapseBlock\Livewire\Admin\Types;
...
{
    use WithFileUploads, EditBlockTrait, SimpleItemActionsTrait, CheckBlockAuthTrait, DeleteImageTrait, PlaceholderBlockTrait;
    ...
    public function render(): View
    {
        ...
        return view('ecb::livewire.admin.types.collapse-text-wire', compact("items"));
    }
}
